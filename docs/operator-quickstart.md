# Operator Quickstart — Citrus Orchard Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0123** (`cloud-itonami-isic-0123`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0123.git
cd cloud-itonami-isic-0123
```
...
- Blueprint governor key: `citrus-operations-governor`
- Likely source path: `citrusops.governor.cljc`
